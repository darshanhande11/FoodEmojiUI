    ...
    return Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            if (columnNumber == '1')
              _buildColumnItem(
                  'assets/cheese.png', 'Sweet cheese', '59', Color(0xFFFBD6F5)),
            if (columnNumber == '1') SizedBox(height: 15.0),
            if (columnNumber == '1')
              _buildColumnItem('assets/popcorn.png', 'Sweet popcorn', '49',
                  Color(0xFFFBD6F5)),
            if (columnNumber == '2')
              _buildColumnItem(
                  'assets/taco.png', 'Tacos', '69', Color(0xFFC2E3FE)),
            if (columnNumber == '2') SizedBox(height: 15.0),
            if (columnNumber == '2')
              _buildColumnItem(
                  'assets/sandwich.png', 'Sandwich', '59', Color(0xFFD7FADA)),
          ],
        ));
  }
